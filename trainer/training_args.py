...
from transformers.utils.import_utils import enable_tf32, is_optimum_neuron_available
...
class TrainingArguments:
    ...
    if is_torch_available():
        from transformers.pytorch_utils import is_torch_greater_or_equal_than_2_8
    ...
    def __post_init__(self):
        ...
        from transformers.integrations import is_kubeflow_available
