...
class TaskTrec(TaskManager):
    ...
    def __init__(
        ...
        self.task_meta = {
            ...
            "paper_year": 2002,  # The year of publication/preprint
            "paper_url": "https://aclanthology.org/C02-1150/",  # URL of the dataset paper
        ...
        self.task_data = {
            ...
            "test": {
                ...
                # "filenames": ["train.jsonl", "test.jsonl"],
                "data": [],
                "num_data": 0,
                "intents": dict(),
            }
    ...
    def raw_data_unification(
        ...
        for task_split in ["train", "valid", "test"]:
            ...
            for idx, raw_item in enumerate(cur_split_raw_data):
                cur_intent_label_text = str(raw_item["label_text"]).strip()
                cur_intent_label_coarse = str(raw_item["label_coarse_text"]).strip()
                cur_intent_label = f"{cur_intent_label_coarse}: {cur_intent_label_text}"
                cur_intent_statement = f"To ask about {cur_intent_label_text.lower()}."

                if cur_intent_label not in self.intent_label2statement:
                    self.intent_label2statement[cur_intent_label] = cur_intent_statement
        ...
        assert set(all_intents_dict.keys()) == set(self.intent_label2statement.keys())
        ...
        for task_split in ["train", "valid", "test"]:
            ...
            for cur_filename in cur_filenames:
                ...
                for raw_item in cur_file_raw_data:
                    ...
                    cur_speaker = "questioner"
                    iu_context = f"Question: {cur_text_raw}"
                    iu_question_raw = f"What is the intent of the question?"
                    ...
                    cur_domain_topic = []
                    cur_domain, cur_topic = "general", f"query about {cur_intent_label_coarse}"
