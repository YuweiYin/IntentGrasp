...
class TaskMixSNIPS(TaskManager):
    ...
    def __init__(
        ...
        self.intent_label2statement = {
            "add to playlist": "To add music to the playlist.",  # 12733,
            "book restaurant": "To book a restaurant.",  # 12907,
            "get weather": "To get the weather information.",  # 12597,
            "play music": "To play music.",  # 12572,
            "rate book": "To rate a book.",  # 12696,
            "search creative work": "To search for a creative work.",  # 12850,
            "search screening event": "To search for screening events.",  # 12816,
        }  # intent labels --> intent statements

        self.intent_label2category = {
            "add to playlist": ["daily life", "music"],  # 12733,
            "book restaurant": ["daily life", "restaurant"],  # 12907,
            "get weather": ["daily life", "weather"],  # 12597,
            "play music": ["daily life", "music"],  # 12572,
            "rate book": ["daily life", "book"],  # 12696,
            "search creative work": ["daily life", "searching"],  # 12850,
            "search screening event": ["daily life", "searching"],  # 12816,
        ...
        for task_split in ["train", "valid", "test"]:
            ...
            for cur_filename in cur_filenames:
                ...
                for raw_item in cur_file_raw_data:
                    ...
                    cur_topic = [str(_cur_intent_labels[0]).strip()]
                    for _cur_intent_label in _cur_intent_labels[1:]:
                        if _cur_intent_label in ["search creative work", "search screening event"]:
                            cur_topic.append("searching")
                        elif _cur_intent_label in ["play music", "add to playlist"]:
                            cur_topic.append("music")
                        else:
                            cur_topic.append(_cur_intent_label)
