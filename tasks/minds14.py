...
class TaskMinds14(TaskManager):
    ...
    def __init__(
        ...
        self.task_meta = {
            ...
            "paper_url": "https://aclanthology.org/2021.emnlp-main.591/",  # URL of the dataset paper
            "license": "CC-BY",  # the releasing license of the original dataset
            "intent_description": {},  # The description of each intent label
        }
        # Section 2: MINDS-14: Dataset Collection
        #   Spoken Data Collection. The spoken data has been collected via crowdsourcing,
        #     relying on the Prolific platform (www.prolific.co/).
        #   We have experimented with two different data collection protocols, which eventually yield very
        #     similar data quality. With both protocols, human subjects are first provided with the particular
        #     intent class, a description of the intent, and three examples for the intent class.
        #     The task is then to provide new spoken utterances associated with the intent class.
        ...
        self.intent_label2statement = {
            "cash deposit": "To ask about or request a cash deposit.",  # 48,
            "card issues": "To ask about card issues.",  # 46,
            "freeze": "To ask for or inquire about card freezing.",  # 45,
            "joint account": "To ask about the joint account.",  # 42,
            "APP error": "To report an APP error.",  # 42,
            "balance": "To inquire about the balance.",  # 41,
            "pay bill": "To inquire about the pay bill.",  # 41,
            "ATM limit": "To inquire about the ATM limit.",  # 41,
            "high value payment": "To inquire about high-value payments.",  # 40,
            "business loan": "To inquire about the business loan.",  # 39,
            "direct debit": "To inquire about the direct debit.",  # 36,
            "address": "To inquire about or change the address.",  # 34,
            "abroad": "To ask for information related to going abroad.",  # 34,
            "latest transactions": "To inquire about the latest transactions.",  # 34,
        }  # intent labels --> intent statements

        self.intent_label2category = {
            "cash deposit": ["daily life", "banking"],  # 48,
            "card issues": ["daily life", "banking"],  # 46,
            "freeze": ["daily life", "banking"],  # 45,
            "joint account": ["daily life", "banking"],  # 42,
            "APP error": ["daily life", "banking"],  # 42,
            "balance": ["daily life", "banking"],  # 41,
            "pay bill": ["daily life", "banking"],  # 41,
            "ATM limit": ["daily life", "banking"],  # 41,
            "high value payment": ["daily life", "banking"],  # 40,
            "business loan": ["daily life", "banking"],  # 39,
            "direct debit": ["daily life", "banking"],  # 36,
            "address": ["daily life", "banking"],  # 34,
            "abroad": ["daily life", "banking"],  # 34,
            "latest transactions": ["daily life", "banking"],  # 34,
    ...
    def raw_data_unification(
        ...
        intent_id2name = {
            ...
            8: "direct debit",
            9: "freeze",
            10: "high value payment",
            11: "joint account",
            12: "latest transactions",
            13: "pay bill",
        }
        ...
        for task_split in ["train", "valid", "test"]:
            ...
            for cur_filename in cur_filenames:
                ...
                cur_data_list = []
                for _t, _i in zip(cur_data["english_transcription"].tolist(), cur_data["intent_class"].tolist()):
                    _i = int(_i)
                    assert _i in intent_id2name
                    cur_data_list.append({
                        "text": str(_t).strip(),
                        "intent": str(intent_id2name[_i]).strip(),
                    })
